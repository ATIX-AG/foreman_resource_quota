...
module ForemanResourceQuota
  class ResourceOrigin
    ...
    def collect_resources!(hosts_resources, missing_hosts_resources, host_objects)
      ...
      sum_resources_and_delete_missing_hosts!(hosts_resources, missing_hosts_resources, host_values)
    end
    ...
    def sum_resources_and_delete_missing_hosts!(hosts_resources, missing_hosts_resources, host_values)
